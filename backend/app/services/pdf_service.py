...
class PDFService:
    ...
    async def generar_pdf_comprobante(
        ...
        datos = {
            ...
            "tipo_documento_nombre": self._get_nombre_tipo_documento(comprobante.cliente.tipo_documento),
        }
    ...
    def _generar_qr_arca(self, comprobante: Comprobante) -> str:
        ...
        datos_qr = {
            ...
            "tipoDocRec": self._get_tipo_documento_codigo(comprobante.cliente.tipo_documento),
