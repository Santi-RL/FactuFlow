...
from app.arca.crypto import load_certificate, load_private_key, verify_certificate_validity
...
class CertificadosService:
    ...
    async def validar_certificado(
        ...
        try:
            ...
            if (cert_public_numbers.n != private_public_numbers.n or 
                cert_public_numbers.e != private_public_numbers.e):
            ...
            logger.info(f"Certificado validado exitosamente. Vence: {info.fecha_vencimiento}")
