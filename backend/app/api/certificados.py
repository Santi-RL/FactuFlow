...
@router.post("/verificar-conexion/{certificado_id}", response_model=VerificacionResponse)
async def verificar_conexion(
    ...
    try:
        ...
        # Determinar ambiente
        ambiente = ArcaAmbiente.HOMOLOGACION if certificado.ambiente == "homologacion" else ArcaAmbiente.PRODUCCION
