...
def load_private_key(key_path: str, password: bytes | None = None):
    ...
    if not key_file.exists():
        raise ArcaCertificateError(f"Archivo de clave privada no encontrado: {key_path}")
...
def sign_tra(tra: str, cert_path: str, key_path: str, key_password: bytes | None = None) -> str:
    """
