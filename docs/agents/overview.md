...
- Release publicada más reciente: `v0.3.2`, desde el tag inmutable que apunta a
...
- `v0.3.2` está publicada: antes de habilitar selectores comprueba
...
checkpoint es desplegar `v0.3.2` por su SHA exacto, sin cambios de base ni
solicitudes de CAE. Después sigue PF-03B sobre DTO de ítem, propiedades
