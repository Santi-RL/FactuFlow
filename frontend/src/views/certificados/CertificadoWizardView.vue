...
import WizardStep5AutorizarServicio from "@/components/certificados/WizardStep5AutorizarServicio.vue";
  ...
  <div class="container mx-auto px-4 py-8">
    ...
    <div class="mt-8">
      ...
      <WizardStep5Verificar
        v-else-if="currentStep === 6 && certificadoCreado"
        :certificado="certificadoCreado"
        @finish="onFinish"
        @prev="goToPrevStep"
      />
