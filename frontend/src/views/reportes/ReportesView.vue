<template>
  <div class="reportes-view">
    <div class="mb-6">
      ...
      <p class="text-gray-600 mt-2">Consulta reportes de ventas, IVA y clientes</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      >
        ...
        <h2 class="text-xl font-bold text-gray-800 mb-2">Subdiario IVA Ventas</h2>
        <p class="text-gray-600 mb-4">
      ...
      >
        ...
        <h2 class="text-xl font-bold text-gray-800 mb-2">Ranking de Clientes</h2>
        <p class="text-gray-600 mb-4">
    ...
    <div class="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
      <div class="flex items-start">
        ...
        <div>
          <h3 class="font-semibold text-blue-900 mb-1">Información sobre reportes</h3>
