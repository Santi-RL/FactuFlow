  ...
  <div>
    ...
    <BaseCard v-else-if="clientesStore.clienteActual">
      <div class="space-y-6">
        <div>
          ...
          <dl class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <dd class="mt-1 text-sm text-gray-900">{{ clientesStore.clienteActual.razon_social }}</dd>
            </div>
            <div>
            ...
            <div>
              <dt class="text-sm font-medium text-gray-500">Condición IVA</dt>
              <dd class="mt-1">
        ...
        <div v-if="clientesStore.clienteActual.domicilio" class="border-t pt-6">
          <h3 class="text-lg font-semibold text-gray-900 mb-4">Domicilio</h3>
          <dl class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <dt class="text-sm font-medium text-gray-500">Dirección</dt>
              <dd class="mt-1 text-sm text-gray-900">{{ clientesStore.clienteActual.domicilio || '-' }}</dd>
            </div>
            <div>
              <dt class="text-sm font-medium text-gray-500">Localidad</dt>
              <dd class="mt-1 text-sm text-gray-900">{{ clientesStore.clienteActual.localidad || '-' }}</dd>
            </div>
            <div>
              <dt class="text-sm font-medium text-gray-500">Provincia</dt>
              <dd class="mt-1 text-sm text-gray-900">{{ clientesStore.clienteActual.provincia || '-' }}</dd>
            </div>
            <div>
              <dt class="text-sm font-medium text-gray-500">Código Postal</dt>
              <dd class="mt-1 text-sm text-gray-900">{{ clientesStore.clienteActual.codigo_postal || '-' }}</dd>
            </div>
          </dl>
        </div>
        ...
        <div class="border-t pt-6">
          ...
          <dl class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <dd class="mt-1 text-sm text-gray-900">{{ clientesStore.clienteActual.email || '-' }}</dd>
            </div>
            <div>
              <dt class="text-sm font-medium text-gray-500">Teléfono</dt>
              <dd class="mt-1 text-sm text-gray-900">{{ clientesStore.clienteActual.telefono || '-' }}</dd>
            </div>
            <div v-if="clientesStore.clienteActual.notas" class="md:col-span-2">
              <dt class="text-sm font-medium text-gray-500">Notas</dt>
              <dd class="mt-1 text-sm text-gray-900">{{ clientesStore.clienteActual.notas }}</dd>
            </div>
          </dl>
        </div>
      </div>
