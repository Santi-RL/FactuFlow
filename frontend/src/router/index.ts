...
const ClienteDetailView = () =>
  import("@/views/clientes/ClienteDetailView.vue");
const EmpresaConfigView = () => import("@/views/empresa/EmpresaConfigView.vue");
const PuntosVentaView = () =>
  import("@/views/puntos_venta/PuntosVentaView.vue");
const ComprobantesListView = () =>
  import("@/views/comprobantes/ComprobantesListView.vue");
const LotesComprobantesView = () =>
  import("@/views/comprobantes/LotesComprobantesView.vue");
const ComprobanteNuevoView = () =>
  import("@/views/comprobantes/ComprobanteNuevoView.vue");
const ComprobanteDetalleView = () =>
  import("@/views/comprobantes/ComprobanteDetalleView.vue");
const CertificadosListView = () =>
  import("@/views/certificados/CertificadosListView.vue");
const CertificadoWizardView = () =>
  import("@/views/certificados/CertificadoWizardView.vue");
const CertificadoExitoView = () =>
  import("@/views/certificados/CertificadoExitoView.vue");
const ReportesView = () => import("@/views/reportes/ReportesView.vue");
const ReporteVentasView = () =>
  import("@/views/reportes/ReporteVentasView.vue");
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          name: "comprobantes-lotes",
          component: LotesComprobantesView,
        },
        {
